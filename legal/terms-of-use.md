...
## 4. Uso permitido
- Consultar dados e preços
- Utilizar ferramentas de comparação
- Salvar favoritos e alertas
- Compartilhar links para conteúdo público

## 5. Uso proibido
- Raspagem de dados em volume sem autorização
- Reprodução comercial de dados sem licença
- Manipulação de preços ou informações
- Criação de múltiplas contas para manipulação
...
## 10. Lei aplicável
Este acordo é regido pela legislação brasileira.
