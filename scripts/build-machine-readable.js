...
const files = {
  ...
  'api/editorial-policy.json': { schemaVersion: '1.0', updatedAt: catalog.verifiedAt, publisher: 'TheBiker Blog', language: 'pt-BR', audience: 'Ciclistas de média e alta experiência', sourcePriority: ['Fabricante oficial', 'TheBiker Shop'], rules: ['Não inferir especificações ausentes', 'Distinguir confirmado, aproximado, pendente e bloqueado', 'Revalidar preço e disponibilidade', 'Não publicar marcas concorrentes'] }
}
